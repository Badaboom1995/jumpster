    ...
    return (
        <div className={`${!visible && 'hidden'} flex justify-between items-start p-[16px] pt-[24px] font-bold`}>
            <div className='flex gap-[8px]'>
                ...
                <div className='bg-white rounded-[12px] px-[12px] py-[4px] font-boldtext-black flex gap-[4px] items-center'><Image className='w-[20px]' src={basket as string} alt='basket'/>Магазин</div>
            </div>
            <div className='rounded-[12px] px-[8px] py-[4px] text-white flex items-center gap-[4px]'><Image src={fire as string} alt='basket'/> {user?.streak_counter} дней</div>
        </div>
    );
};
